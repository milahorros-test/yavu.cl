...
<div class="form-group has-feedback has-feedback-left col-sm-6">
	{!!Form::label('Rut:')!!}
	{!!Form::text('rut',null,['class'=>'form-control input-lg','placeholder'=>'Ingrese su rut','required'=>'required'])!!}
</div>
...
<div class="form-group has-feedback has-feedback-left col-sm-6">
	{!!Form::label('Nickname:')!!}
	{!!Form::text('login',null,['class'=>'form-control input-lg','placeholder'=>'Ingrese su nombre de usuario','required'=>'required'])!!}			
</div>
